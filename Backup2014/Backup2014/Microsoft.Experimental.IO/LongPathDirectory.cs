...
namespace Microsoft.Experimental.IO {
    ...
    public static class LongPathDirectory {
        ...
        public static string[] GetDirectories(string path)
        {
            ...
            foreach( string elem in EnumerateFileSystemEntries(path, null, includeDirectories: true, includeFiles: false) )
            {
                result.Add(elem);
            }
        ...
        {
            List<string> result = new List<string>();
            foreach (string elem in EnumerateFileSystemEntries(path, null, includeDirectories: false, includeFiles: true))
            {
                result.Add(elem);
            }
            return result.ToArray();
